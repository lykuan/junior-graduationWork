<template>
  <div class="follow" @click="checkAnotherUserInfo">
    <div class="avatar-box">
      <img
        :src="followInfo.userInfo.avatarURL"
        v-if="followInfo.userInfo.avatarURL != 'null'"
        alt=""
      />
      <img
    ...
    <div class="detail-box">
      <div>
        <div style="height: 28px">
          ...
          <span style="color: #000; font-weight: 600" v-html="emphasizedName">
          </span>
          <span class="gender">
            <a-icon
              type="man"
...
export default {
  ...
  created() {
    this.emphasizedName = this.followInfo.userInfo.nickname
    this.follows = this.followInfo.userInfo.follower;
    const query = this.search.query;
     const reg = new RegExp(`${query}`, "ig");

    if (Array.isArray(this.followInfo.userInfo.nickname.match(reg))) {
        this.emphasizedName = this.followInfo.userInfo.nickname.replace(
          reg,
